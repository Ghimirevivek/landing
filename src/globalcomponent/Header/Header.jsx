  ...
  return (
    <div className='bg-header-gradient bg-cover  bg-no-repeat  w-full min-h-[10rem] flex items-center justify-center relative'>
      ...
      >
        ...
        <div className='top-20 left-0 z-10 absolute w-full flex flex-col items-center justify-center'>
          {' '}
          <div
            style={{
            ...
            className={`flex lg:hidden items-center justify-between w-[90%]  transition-all ease-in delay-100 duration-300 opacity-0 h-0 ${
